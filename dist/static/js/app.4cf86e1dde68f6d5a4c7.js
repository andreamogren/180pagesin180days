...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  data() {
    return {
      menuItems: [{ name: 'Vanishing button', state: 'vanishingbutton' }, { name: 'Crystal ball', state: 'crystalball' }, { name: 'Hangry Sami', state: 'hangrysami' }, { name: 'Dog Generator', state: 'dogGenerator' }]
    };
  },
  props: {
  ...
  components: {
    CookieLaw: __WEBPACK_IMPORTED_MODULE_0_vue_cookie_law___default.a
  },
  methods: {},
  computed: {}
});
...
"use strict";
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"topbar"},[_c('h1',[_vm._v("Welcome to Andrea's Vue challenge!")]),_vm._v(" "),_c('p',[_vm._v("I started on the 20th of September 2017.")]),_vm._v(" "),_c('nav',{staticClass:"topbar-navigation"},[_c('ul',_vm._l((_vm.menuItems),function(item){return _c('li',[_c('router-link',{attrs:{"to":{ name: item.state }}},[_vm._v(_vm._s(item.name))])],1)}))]),_vm._v(" "),_c('cookie-law',{attrs:{"theme":"mytheme"}},[_c('div',{attrs:{"slot":"message"},slot:"message"},[_vm._v("\n    Lorem Ipsum "),_c('router-link',{attrs:{"to":"https://comprend.com"}},[_vm._v("Click here")])],1)])],1)}
var staticRenderFns = []
...
//# sourceMappingURL=app.4cf86e1dde68f6d5a4c7.js.map